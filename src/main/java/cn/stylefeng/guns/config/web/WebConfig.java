...
public class WebConfig implements WebMvcConfigurer {
	...
	/*
	 * @Autowired private GunsProperties gunsProperties;
	 */
...
//        registry.addResourceHandler("/assets/**").addResourceLocations("classpath:/assets/");
    ...
    public FilterRegistrationBean xssFilterRegistration() {
        ...
        // 这里可以加不被xss过滤的接口
        xssFilter.setUrlExclusion(Arrays.asList("/app/seller/addEditPayMethod","/proclamationMgr/update","/proclamationMgr/add","/carouselMgr/update", "/carouselMgr/add","/notice/update", "/notice/add","/helpMgr/add","/helpMgr/update"));
    ...
    public DefaultKaptcha kaptcha() {
        ...
        properties.put("kaptcha.border.color", "76,238,209");
