...
public class RoleService extends ServiceImpl<RoleMapper, Role> {
    ...
    public void delRoleById(Long roleId) {
        ...
        if (roleId.equals(Const.MERCHANT_ROLE_ID)) {
            throw new ServiceException(BizExceptionEnum.CANT_DELETE_MERCHANT);
        }
        if (roleId.equals(Const.ACCPERT_ROLE_ID)) {
            throw new ServiceException(BizExceptionEnum.CANT_DELETE_ACCEPTER);
        }
        if (roleId.equals(Const.AGENT_ROLE_ID)) {
            throw new ServiceException(BizExceptionEnum.CANT_DELETE_AGENT);
        }
        //缓存被删除的角色名称
