...
@Controller
@RequestMapping("/sellerAccountUpdateMgr")
public class SellerAccountUpdateController extends BaseController {

	private static String PREFIX = "/modular/system/seller/"; 
	...
	private AccountUpdateMgrService accountUpdateService;
	  ...
	  @RequestMapping("")
	  public String index() {	
		return PREFIX+ "sellerAccountUpdate.html";  
	  }
