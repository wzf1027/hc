...
public class ConstantFactory implements IConstantFactory {
    ...
    private SellerSysMapper sellerMapper  = SpringContextHolder.getBean(SellerSysMapper.class);
	...
	@Override
	public String getSellerPhone(Long sellerId) {
	...
	@Override
	public UserPayMethodFeeSetting getUserPayMethodFeeSetting(Long userId) {
		return userMapper.getPayMethodFeeByUserId(userId);
	}

	@Override
	public UserRecommendRelation getUserRecommendRelationByUserId(Long userId) {
		return userMapper.getUserRecommendRelationByUserId(userId);
	}

	@Override
	public UserBonusSetting getUserBonusSetting(UserBonusSetting setting) {
		return userMapper.getUserBonusSetting(setting);
	}

	@Override
	public String getRecommendId(Long userId) {
		return userMapper.getRecommendId(userId);
	}

	@Override
	public List<UserWallter> getUserWallterListByUserId(Long userId) {
		return userMapper.selectUserWallter(userId);
	}

	@Override
	public Long getMerchantNumberByAgentId(Long userId) {
		return userMapper.getMerchantNumberByAgentId(userId);
	}

    @Override
    public String getUserAccountCodeById(Long userId) {
        User user = userMapper.selectById(userId);
        if (user != null) {
